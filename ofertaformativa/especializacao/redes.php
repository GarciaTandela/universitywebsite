...
<div class="section container z-depth-0" style="padding-bottom: 68px; margin-top: 15px;">
  <div class="center-align">
      <h5 style="text-transform: uppercase;">Especialização em Administração de Redes de Computadores</h5> 
  </div>
  ...
  <div>
    ...
    <div>
      ...
      <blockquote>Poderão inscrever-se no Curso de Estudos Superiores Especializados em Redes de Computadores, os candidatos que tenham concluído o ensino secundário, preferencialmente aqueles que possuam formação nas áreas da Informática, ou no domínio das ciências exactas.
      </blockquote>  
    </div>
    ...
    <div>
      ...
      <blockquote>
                  Instalação, manutenção e reparação de equipamentos industriais;<br>
                  Instalação, reparação e manutenção de equipamentos electrónicos ou computacionais;<br>
    ...
    <div>
      ...
      <blockquote>
        O objectivo deste curso é capacitar o estudante para actuar na área de Redes de Computadores e telecomunicações, esta última com foco em redes WAN’s e internet; servidores de redes e sistemas de comunicações aplicados em redes locais e de longa distância. 
        <br><br>
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              ...
              <tr>
                <td>Virtualização de Servidores e Desktops</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Rede de Sensores Sem Fio</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
