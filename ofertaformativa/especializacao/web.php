...
<div class="section container z-depth-0" style="padding-bottom: 68px; margin-top: 15px;">
  <div class="center-align">
      <h5 style="text-transform: uppercase;">Especialização em Desenvolvimento para Web e Dispositivos Móveis</h5> 
  </div>
  ...
  <div>
    ...
    <div>
      ...
      <blockquote>Poderão inscrever-se no Curso de Estudos Superiores Superiores Especializados em Desenvolvimento para a Web e Dispositivos Móveis, os candidatos que tenham concluído o ensino secundário, preferencialmente aqueles que possuam formação nas áreas das Tecnologias Informática, Computação ou Ciências exactas.
      </blockquote>  
    </div>

    <div>
      <h5 class="center-align">Saídas Profissionais</h5>
      <blockquote>Os técnicos de Desenvolvimento para a Web e Dispositivos Móveis podem desenvolver actividade profissional em diversas áreas, entre as quais se destacam:<br><br>
                  Técnico Superior Profissional em Desenvolvimento para a Web e Dispositivos Móveis;<br>
                  Programador de produtos de software para a web e dispositivos móveis;<br>
                  Técnico especialista em tecnologias Web e mobile e programação de sistemas de informação;<br>
                  Administrador de plataformas digitais empresariais (Públicas ou Privadas);<br>
                  Gestor de produtos de software.
      </blockquote>  
    </div>
    ...
    <div>
      ...
      <blockquote>
        O Curso de Estudos Superiores Especializados em Desenvolvimento Web pretende formar profissionais que desempenhem funções charneira entre o designer e o engenheiro de programação no âmbito da concepção, desenvolvimento e implementação de aplicações multimédia para a Web e para dispositivos móveis. 
        <br><br>
      ...
      <div class="row">
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              ...
              <tr>
                <td>Redes de Comunicação de Dados</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              <tr>
                <td>Programação Orientada a Objectos</td>
                <td>2º Semestre</td>
              </tr>
              <tr>
                <td>Programação Web - Cliente</td>
                <td>2º Semestre</td>
              </tr>
              <tr>
                <td>Arquitetura e Sistemas Operativos Móveis</td>
                <td>2º Semestre</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Design e Comunicação Multimédia</td>
                <td>2º Semestre</td>
              </tr>
            </tbody>
          </table>  
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              ...
              <tr>
                <td>Programação Dispositivos Móveis</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Sistemas de Gestão de Conteúdos</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Tecnologias Multimédia Avançadas</td>
                <td>1º Semestre</td>
              </tr>
            </tbody>
          </table>  
