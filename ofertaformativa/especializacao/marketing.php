...
<div class="section container z-depth-0" style="padding-bottom: 68px; margin-top: 15px;">
  <div class="center-align">
      <h5 style="text-transform: uppercase;">Especialização em Marketing e Publicidade</h5> 
  </div>
  ...
  <div>
    ...
    <div>
      ...
      <blockquote>Poderão inscrever-se no Curso de Estudos Superiores Especializados em Marketing e Publicidade, os candidatos que tenham concluído o ensino secundário.
      </blockquote>  
    </div>

    <div>
      <h5 class="center-align">Saídas Profissionais</h5>
      <blockquote>O Curso de Especialização em Marketing e Publicidade da UGS possibilita a aquisição de conhecimentos especializados que permitirão aos novos quadros desta área exercer funções técnicas, de chefia ou direção, em empresas e instituições, nas seguintes áreas:
                  <br><br>
                  Consultoria especializada no domínio do Marketing, nomeadamente nos segmentos do planeamento e gestão de Marketing;<br>
                  Estudo e Análise de Mercados e de Consumidores;<br>
                  Comunicação, Imagem e Relações Públicas;<br>
                  Gestão de Marcas e Internacionalização de Empresas;<br>
                  Gestão de Produtos e Serviços;<br>
                  Gestão de Marcas e Comunicação;<br>
                  Comercial e de Vendas das Empresas;<br>
                  Departamentos/Gabinetes de comunicação institucional.
      </blockquote>  
    </div>
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              ...
              <tr>
                <td>Gestão de Produtos e Marcas</td>
                <td>2º Semestre</td>
              </tr>
              <tr>
                <td>Mercados e Redes Comerciais</td>
                <td>2º Semestre</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Fixação de Preços em Marketing</td>
                <td>2º Semestre</td>
              </tr>
            </tbody>
          </table>  
      ...
      <div class="row">
        ...
        <div class="col s12 m6 l6">
          <table class="highlight">
            ...
            <tbody>
              <tr>
                <td>Comércio Eletrónico e WebMarketing</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Marketing Industrial</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Marketing de Serviços</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
                <td>Marketing Relacional e CRM</td>
                <td>1º Semestre</td>
              </tr>
              <tr>
