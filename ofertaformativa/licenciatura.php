...
<div class="section" style="padding-bottom: 68px;">
    <div class="center-align">
        <h5 style="text-transform: uppercase;">Cursos de Licenciatura</h5> 
    </div>
    <!-- Row 1 -->
    <div class="row container">
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/enginf.php" class="black-text">Engenharia Informática</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/infgest.php" class="black-text">Informática de Gestão</a></td>
                  </tr>
                </tbody>
             </table>
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/administracao.php" class="black-text">Ciências Política e Administração do Território</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/direito.php" class="black-text">Direito</a></td>
                  </tr>
                </tbody>
             </table>
    ...
    <div class="row container">
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/gestao.php" class="black-text">Organização e Gestão de Empresas</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/recursos.php" class="black-text">Gestão de Recursos Humanos</a></td>
                  </tr>
                </tbody>
             </table>
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/lingua.php" class="black-text">Comunicação Empresarial e Línguas</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="licenciatura/marketing.php" class="black-text">Gestão Comercial e Marketing</a></td>
                  </tr>
                </tbody>
             </table>
