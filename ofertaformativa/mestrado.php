...
<div class="section" style="padding-bottom: 68px;">
    <div class="center-align">
        <h5 style="text-transform: uppercase;">Cursos de Mestrado</h5> 
    </div>
    <!-- Row 1 -->
    <div class="row container">
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/redes.php" class="black-text">Gestão de Redes de Computadores e Sistemas de Comunicações</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/mobile.php" class="black-text">Desenvolvimento de Aplicações para Dispositivos Móveis</a></td>
                  </tr>
                </tbody>
             </table>
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                <thead class="blue white-text">
                  <tr>
                      <th><h6 style="text-transform: uppercase;">Faculdade de Ciências Políticas e Jurídicas</h6></th>
                  </tr>
                </thead>

                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/direitojudiciario.php" class="black-text">Direito Judiciário</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/direitoempresarial.php" class="black-text">Direito Empresarial</a></td>
                  </tr>
                </tbody>
             </table>
    ...
    <div class="row container">
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/financas.php" class="black-text">Finanças e Mercados Financeiros</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/estrategia.php" class="black-text">Gestão Estratégica de Recursos Humanos</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/logistica.php" class="black-text">Gestão da Logística e dos Transportes</a></td>
                  </tr>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/comercial.php" class="black-text">Gestão Comercial</a></td>
                  </tr>
                </tbody>
             </table>
        ...
        <div class="col s12 m6 l6">
            ...
            <table class="highlight">
                ...
                <tbody>
                  <tr>
                    <td style="cursor: pointer;"><a href="mestrado/marketing.php" class="black-text">Marketing, Publicidade e Comunicação Empresarial</a></td>
                  </tr>
                </tbody>
             </table>
