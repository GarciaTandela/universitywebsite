...
<div class="content">
  <div class="row">
      <div class="col s12 l10 offset-l1 m5 ajuste">
            <h5 class="center">Mensagens dos Clientes</h5>

            <div class="card">
              <div class="card-tabs">
                <ul class="tabs tabs-fixed-width">
                  <li class="tab"><a class="active" href="#test4">Todas mensagens</a></li>
                  <li class="tab"><a href="#test5">Visualizadas</a></li>
                  <li class="tab"><a href="#test6">Não visualizadas<span class="new badge" data-badge-caption="" id="Count"></span></a></li>
                </ul>
              </div>
              <div class="card-content">
                ...
                <div id="test4">
                  <div class="row">
                    ...
                    <!-- Listas de mensagens clientes-->
                    <div class="col s12 l6 grey lighten-4">
                      
                      <ul class="collection" id="todosClientes" style="height: 403px; overflow: auto;">
                      ...
                      <div id="modal1" class="modal">
                        <div class="modal-content">
                          <h4>Informação!</h4>
                          <p>Mensagem apagada com êxito.</p>
                        </div>
                    ...
                    <div class="col s12 l6 white ">
                      <div class="">
                        <span class="title" id="Nome">Nome: Garcia Tandela</span>
                            <p id="Contacto">Contacto: 926920530<br>
                               <p id="Status">Status: Mensagem lida</p>
                            </p>
                            <br>
                    ...
                    <div class="col s12 l6 grey lighten-4">
                      <ul class="collection">
                          <li class="collection-item avatar">
                            ...
                            <p>Contacto: 926920530<br>
                               Status: Mensagem lida
                            </p>
                            <br>
                            <p class="truncate">One common flaw we've seen in many frameworks is a lack of support for truly responsive text. While elements on the page resize fluidly, text still resizes on a fixed basis. To ameliorate this problem, for text heavy pages, we've created a class that fluidly scales text size and line-height to optimize readability for the user. Line length stays between 45-80 characters and line height scales to be larger on smaller screens.</p>
                            <a href="#modal2" class="secondary-content modal-trigger tooltipped" data-position="bottom" data-tooltip="Apagar mensagem"><i class="material-icons">delete</i></a>
                          </li>
                          <li class="collection-item avatar">
                            <img src="assets/img/gaming2.jpg" alt="" class="circle">
                            <span class="title">Garcia Tandela</span>
                ...
                <div id="test6">
                  <div class="row">
                    ...
                    <div class="col s12 l6">
                      <div class="center">
                        <h6>Mensagem não seleccionada</h6>
                      </div>
                    </div>
