...
<!-- Section Video-->
<div class="section container" style="margin-bottom: 200px; margin-top: 70px;">
    <div class="center-align">
        <h5 style="text-transform: uppercase;">Video Institucional</h5> 
    </div>
    <div class="video-container">
        <video class="responsive-video" controls>
          <source src="../assets/video/UniversidadeGregórioSemedo.mp4" type="video/mp4">
        </video>
    </div>
